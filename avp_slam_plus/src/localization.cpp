...
void cameraCloudHandler(
    ...
    //   for real scene,should adapt deep learning method,detecting valid
    //   feature point
    ...
    tfMap2Camera.sendTransform(tf::StampedTransform(
        mapToCamera, ros::Time::now(), "/map", "/camera0_link"));
    ...
    std::cout << "now robot is in x " << currentX << " y " << currentY
              << "  z  " << currentZ << std::endl;
...
int main(int argc, char *argv[]) {
    ...
    nh.param<double>("icpMaxCorrespondenceDistance",
                     icpMaxCorrespondenceDistance, 20);
    nh.param<int>("icpMaximumIterations", icpMaximumIterations, 100);
    nh.param<double>("icpTransformationEpsilon", icpTransformationEpsilon,
                     1e-10);
    ...
    nh.param<double>("ndtTransformationEpsilon", ndtTransformationEpsilon,
                     1e-10);
