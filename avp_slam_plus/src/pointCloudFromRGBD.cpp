        ...
        if (!camera0CloudBuf.empty() && !camera1CloudBuf.empty() &&
            ...
            *camera5Cloud = camera5CloudDS;
            ...
            for (int i = 0; i < camera1PointSize; i++) {
                transformToFrame(&camera1Cloud->points[i],
                                 &camera1Cloud->points[i], q_c0c1, t_c0c1);
            }

            for (int i = 0; i < camera2PointSize; i++) {
                transformToFrame(&camera2Cloud->points[i],
                                 &camera2Cloud->points[i], q_c0c2, t_c0c2);
            }

            for (int i = 0; i < camera3PointSize; i++) {
                transformToFrame(&camera3Cloud->points[i],
                                 &camera3Cloud->points[i], q_c0c3, t_c0c3);
            }

            for (int i = 0; i < camera4PointSize; i++) {
                transformToFrame(&camera4Cloud->points[i],
                                 &camera4Cloud->points[i], q_c0c4, t_c0c4);
            }

            for (int i = 0; i < camera5PointSize; i++) {
                transformToFrame(&camera5Cloud->points[i],
                                 &camera5Cloud->points[i], q_c0c5, t_c0c5);
            }
            ...
            *cameraFrameCloud = *cameraFrameCloud + *camera5Cloud;
            ...
            removeClosedPointCloud(*cameraFrameCloud, *cameraFrameCloud,
                                   closePointThresh);
            removeFarPointCloud(*cameraFrameCloud, *cameraFrameCloud,
                                farPointThresh);
